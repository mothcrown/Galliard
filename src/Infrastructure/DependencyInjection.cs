...
public static class DependencyInjection
{
    ...
    {
        var connectionString = builder.Configuration.GetConnectionString("GalliardDb");
        Guard.Against.Null(connectionString, message: "Connection string 'GalliardDb' not found.");
